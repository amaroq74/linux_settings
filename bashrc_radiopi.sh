...
alias nrigctl='rigctl --model=2 -r 127.0.0.1:4532'
...
alias ardop='/home/ryan/bin/ardopcf -G 8088 8515 plughw:2,0 plughw:2,0 -H "TRAILER 140;DRIVELEVEL 53"'
...
alias smodepkt='lrigctl V VFOA M PKTFM 0'
alias smodefm='lrigctl V VFOA M FM 0'
alias smodelsb='lrigctl V VFOA M LSB 0'
alias smodeusb='lrigctl V VFOA M USB 0'
alias smodecw='lrigctl V VFOA M CW 0'
