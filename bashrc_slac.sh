...
alias rssh='ssh ryan@gw.amaroq.net -p 2222 -C -Y -R:5922:127.0.0.1:22 -R:5910:127.0.0.1:5900'
...
alias x2024.1='psApp x2024.1; source /afs/slac.stanford.edu/g/reseng/xilinx/2024.1/Vivado/2024.1/settings64.sh'
